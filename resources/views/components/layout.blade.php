...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Scripts -->
        @vite(['resources/css/vendor/laravel-admin/admin/app.scss', 'resources/js/vendor/laravel-admin/admin/app.js', 'resources/js/vendor/laravel-admin/form-builder/field.js'])
    </head>
