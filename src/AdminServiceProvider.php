    ...
    public function boot()
    {
        ...
        if ($this->app->runningInConsole()) {
            ...
            $this->publishes([
                ...
                __DIR__ . '/../stubs/config/auth.php' => base_path('config/auth.php'),
                __DIR__ . '/../stubs/config/form-builder.php' => base_path('config/form-builder.php'),
                ...
                __DIR__ . '/../stubs/routes/breadcrumbs.php' => base_path('routes/breadcrumbs.php'),
